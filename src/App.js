...
// get all books data from the BooksAPI
  componentDidMount(){
    BooksAPI.getAll().then((response)=> this.setState({booksData:response}))
  }
  render() {
    return (
      ...
      <div className="app">
        <Route exact path='/' render={() => (
          ...
          <BookShelves Books={this.state.booksData} UpdateShelve={this.modifyShelve}/>
          {/* Search Btn Part*/}
         ...
         <Route exact path='/search' component={() =><SearchBooks bks={this.state.booksData} changeShelve={this.modifyShelve}/>}/>
